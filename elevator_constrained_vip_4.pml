/* elevator_constrained_vip_4.pml
   Constrained 4-floor model with one VIP request present at init.
   Monitor includes vip_goal_reached progress label when VIP is served.
*/
